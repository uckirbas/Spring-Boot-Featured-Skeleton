...
import com.example.servicito.domains.address.models.dto.DistrictDto
import com.example.servicito.domains.address.models.entities.District
import com.example.servicito.domains.address.models.mappers.DistrictMapper
...
class DistrictController(
    ...
    override fun search(@RequestParam("q", defaultValue = "") query: String,
                        ...
                        @RequestParam("page", defaultValue = "10") size: Int): ResponseEntity<Page<DistrictDto>> {
