...
import com.example.servicito.domains.address.models.dto.DivisionDto
import com.example.servicito.domains.address.models.entities.Division
import com.example.servicito.domains.address.models.mappers.DivisionMapper
import com.example.servicito.domains.address.services.DivisionService
...
class DivisionController(
    ...
    fun search(@RequestParam("q", defaultValue = "") query: String,
        ...
        val divisions: Page<Division> = this.divisionService.search(query, page, 10)
