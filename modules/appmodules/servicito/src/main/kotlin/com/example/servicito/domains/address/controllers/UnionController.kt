...
import com.example.servicito.domains.address.models.dto.UnionDto
import com.example.servicito.domains.address.models.entities.Union
import com.example.servicito.domains.address.models.mappers.UnionMapper
import com.example.servicito.domains.address.services.UnionService
...
class UnionController @Autowired constructor(
    ...
    override fun search(@RequestParam("q", defaultValue = "") query: String,
                        ...
                        @RequestParam("page", defaultValue = "10") size: Int): ResponseEntity<Page<UnionDto>> {
