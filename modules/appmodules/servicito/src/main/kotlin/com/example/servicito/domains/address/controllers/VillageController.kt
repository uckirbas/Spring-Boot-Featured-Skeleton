...
import com.example.servicito.domains.address.models.dto.VillageDto
import com.example.servicito.domains.address.models.entities.Village
import com.example.servicito.domains.address.models.mappers.VillageMapper
import com.example.servicito.domains.address.services.VillageService
...
class VillageController @Autowired constructor(
    ...
    override fun search(@RequestParam("q", defaultValue = "") query: String,
                        ...
                        @RequestParam("page", defaultValue = "10") size: Int): ResponseEntity<Page<VillageDto>> {
