...
@RestController
@Tag(name = Constants.Swagger.ADDRESS, description = Constants.Swagger.REST_API)
class AddressController @Autowired constructor(
    ...
    @Operation(summary = Constants.Swagger.SEARCH_ALL_MSG + Constants.Swagger.ADDRESS)
    ...
    @Operation(summary = Constants.Swagger.GET_MSG + Constants.Swagger.ADDRESS + Constants.Swagger.BY_ID_MSG)
    ...
    @Operation(summary = Constants.Swagger.POST_MSG + Constants.Swagger.ADDRESS)
    ...
    @Operation(summary = Constants.Swagger.PATCH_MSG + Constants.Swagger.ADDRESS)
    ...
    @Operation(summary = Constants.Swagger.DELETE_MSG + Constants.Swagger.ADDRESS + Constants.Swagger.BY_ID_MSG)
