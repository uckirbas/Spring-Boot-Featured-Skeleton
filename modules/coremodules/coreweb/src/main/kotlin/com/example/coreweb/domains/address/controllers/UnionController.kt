...
@RestController
@Tag(name = Constants.Swagger.UNION, description = Constants.Swagger.REST_API)
class UnionController @Autowired constructor(
    ...
    @Operation(summary = Constants.Swagger.SEARCH_ALL_MSG + Constants.Swagger.UNION)
    ...
    @Operation(summary = Constants.Swagger.GET_MSG + Constants.Swagger.UNION)
    ...
    @Operation(summary = Constants.Swagger.POST_MSG + Constants.Swagger.UNION)
    ...
    @Operation(summary = Constants.Swagger.PATCH_MSG + Constants.Swagger.UNION)
    ...
    @Operation(summary = Constants.Swagger.DELETE_MSG + Constants.Swagger.UNION)
