...
@RestController
@Tag(name = Constants.Swagger.UPAZILA, description = Constants.Swagger.REST_API)
class UpazilaController @Autowired constructor(
    ...
    @Operation(summary = Constants.Swagger.SEARCH_ALL_MSG + Constants.Swagger.UPAZILA)
    ...
    @Operation(summary = Constants.Swagger.GET_MSG + Constants.Swagger.UPAZILA)
    ...
    @Operation(summary = Constants.Swagger.POST_MSG + Constants.Swagger.UPAZILA)
    ...
    @Operation(summary = Constants.Swagger.PATCH_MSG + Constants.Swagger.UPAZILA)
    ...
    @Operation(summary = Constants.Swagger.DELETE_MSG + Constants.Swagger.UPAZILA)
